...
using DCornejoTallerDatabaseFirst.Models;

namespace DCornejoTallerDatabaseFirst.Controllers
{
    public class ArtistasController : Controller
    {
        private DCCancionesLocalDBEntities db = new DCCancionesLocalDBEntities();
